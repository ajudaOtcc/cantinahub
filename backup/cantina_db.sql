...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cantina_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `entradas` (
  ...
  CONSTRAINT `FK_entradas` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`)
